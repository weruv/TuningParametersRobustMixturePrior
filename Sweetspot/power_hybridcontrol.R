power_hybridcontrol <- function(Delta, n_c, n_t, robust_component_location, mu_ext, n_ext, CONTROL.SIGMA, TREAT.SIGMA, ext.SIGMA, n_robust, w, H0Diff, H1Diff, muE, cE, nsim) {
  set.seed(123)
